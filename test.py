...
test_dataset = ISIC2018Dataset(
    image_dir="/home/teaching/mednca_scratch_arnavk/data/ISIC2018_Task1-2_Test_Input",
    mask_dir="/home/teaching/mednca_scratch_arnavk/data/ISIC2018_Task1_Test_GroundTruth",
    transform=transform
)
